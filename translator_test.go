...
func TestTranslatorBlocksMySQLBeginPessimisticToPostgresViaParserHooks(t *testing.T) {
	...
	_, err = translator.Translate(context.Background(), "BEGIN PESSIMISTIC")
	if err == nil {
		t.Fatalf("Translate() error = nil, want parser adaptation error")
	}
...
func TestTranslatorBlocksMySQLCommitAndNoChainToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	_, err = translator.Translate(context.Background(), "COMMIT AND NO CHAIN")
	if err == nil {
		t.Fatalf("Translate() error = nil, want parser adaptation error")
	}
...
func TestTranslatorBlocksMySQLRollbackNoReleaseToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	_, err = translator.Translate(context.Background(), "ROLLBACK NO RELEASE")
	if err == nil {
		t.Fatalf("Translate() error = nil, want parser adaptation error")
	}
	...
	if adaptationErr.StatementKind != "rollback" {
		t.Fatalf("ParserAdaptationError.StatementKind = %q, want %q", adaptationErr.StatementKind, "rollback")
	}
	if adaptationErr.Status != "recognized_unadapted" {
		t.Fatalf("ParserAdaptationError.Status = %q, want %q", adaptationErr.Status, "recognized_unadapted")
	}
...
func TestTranslatorTranslatesMySQLSetTransactionIsolationLevelToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SET TRANSACTION ISOLATION LEVEL REPEATABLE READ")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}
...
func TestTranslatorTranslatesMySQLSetSessionTransactionIsolationLevelToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SET SESSION TRANSACTION ISOLATION LEVEL READ COMMITTED")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}
...
func TestTranslatorTranslatesMySQLSetTransactionIsolationAssignmentDefaultSessionToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SET transaction_isolation = 'READ-COMMITTED'")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}
...
func TestTranslatorTranslatesMySQLSetAtAtSessionTransactionIsolationAssignmentToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
...
func TestTranslatorTranslatesMySQLSetSessionTxIsolationAssignmentToPostgresViaParserHooks(t *testing.T) {
	...
	result, err := translator.Translate(context.Background(), "SET SESSION tx_isolation = 'READ-COMMITTED'")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}
...
func TestTranslatorTranslatesMySQLSetSessionTxReadOnlyOnAssignmentToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SET SESSION tx_read_only = ON")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}
...
func TestTranslatorTranslatesMySQLSetSessionTxReadOnlyOffAssignmentToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SET SESSION tx_read_only = OFF")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}
...
func TestTranslatorTranslatesMySQLSetTransactionReadOnlyAssignmentDefaultSessionToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SET transaction_read_only = ON")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}
...
func TestTranslatorTranslatesMySQLSetAtAtSessionTransactionReadOnlyAssignmentToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
...
func TestTranslatorBlocksMySQLSetGlobalTransactionIsolationLevelToPostgresViaParserHooks(t *testing.T) {
	...
	_, err = translator.Translate(context.Background(), "SET GLOBAL TRANSACTION ISOLATION LEVEL READ COMMITTED")
	if err == nil {
		t.Fatalf("Translate() error = nil, want parser adaptation error")
	}
...
func TestTranslatorTranslatesMySQLShowFullTablesLikeToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SHOW FULL TABLES LIKE 'user%'")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}

	want := `SELECT table_name AS "Tables_in_current_schema", CASE WHEN table_type = 'VIEW' THEN 'VIEW' ELSE 'BASE TABLE' END AS "Table_type" FROM information_schema.tables WHERE table_schema = current_schema() AND table_type IN ('BASE TABLE', 'VIEW') AND table_name ILIKE 'user%' ORDER BY table_name`
	if result.SQL != want {
		t.Fatalf("Translate() SQL = %q, want %q", result.SQL, want)
	}
}
...
func TestTranslatorTranslatesMySQLShowColumnsWhereFieldEqualsToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SHOW COLUMNS FROM `users` WHERE Field = 'id'")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}

	want := `SELECT a.attname AS "Field", format_type(a.atttypid, a.atttypmod) AS "Type", CASE WHEN a.attnotnull THEN 'NO' ELSE 'YES' END AS "Null", CASE WHEN EXISTS (SELECT 1 FROM pg_index ix WHERE ix.indrelid = t.oid AND ix.indisprimary AND a.attnum = ANY(ix.indkey)) THEN 'PRI' WHEN EXISTS (SELECT 1 FROM pg_index ix WHERE ix.indrelid = t.oid AND ix.indisunique AND ix.indnkeyatts = 1 AND a.attnum = ANY(ix.indkey)) THEN 'UNI' WHEN EXISTS (SELECT 1 FROM pg_index ix WHERE ix.indrelid = t.oid AND a.attnum = ANY(ix.indkey)) THEN 'MUL' ELSE '' END AS "Key", pg_get_expr(ad.adbin, ad.adrelid) AS "Default", CASE WHEN a.attidentity IN ('a', 'd') THEN 'auto_increment' WHEN a.attgenerated = 's' THEN 'STORED GENERATED' ELSE '' END AS "Extra" FROM pg_attribute a JOIN pg_class t ON t.oid = a.attrelid JOIN pg_namespace n ON n.oid = t.relnamespace LEFT JOIN pg_attrdef ad ON ad.adrelid = a.attrelid AND ad.adnum = a.attnum WHERE t.relkind IN ('r', 'p', 'v', 'm', 'f') AND t.relname = 'users' AND pg_table_is_visible(t.oid) AND a.attname = 'id' AND a.attnum > 0 AND NOT a.attisdropped ORDER BY a.attnum`
	if result.SQL != want {
		t.Fatalf("Translate() SQL = %q, want %q", result.SQL, want)
	}
}

func TestTranslatorTranslatesMySQLShowFullColumnsLikeToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SHOW FULL COLUMNS FROM `users` LIKE 'id%'")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}
	...
	if !strings.Contains(result.SQL, `AND a.attname ILIKE 'id%'`) {
		t.Fatalf("Translate() SQL = %q, want LIKE predicate", result.SQL)
	}
}

func TestTranslatorTranslatesMySQLShowFullColumnsWhereFieldEqualsToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SHOW FULL COLUMNS FROM `users` WHERE Field = 'id'")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}
	...
	if !strings.Contains(result.SQL, `AND a.attname = 'id'`) {
		t.Fatalf("Translate() SQL = %q, want WHERE predicate", result.SQL)
	}
}
...
func TestTranslatorTranslatesMySQLShowIndexWhereKeyNameToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SHOW INDEX FROM `users` WHERE Key_name = 'idx_users_name'")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}

	want := `SELECT t.relname AS "Table", CASE WHEN ix.indisunique THEN 0 ELSE 1 END AS "Non_unique", i.relname AS "Key_name", k.ordinality AS "Seq_in_index", CASE WHEN k.attnum = 0 THEN NULL ELSE a.attname END AS "Column_name", 'A' AS "Collation", NULL AS "Cardinality", NULL AS "Sub_part", NULL AS "Packed", CASE WHEN a.attnotnull THEN '' ELSE 'YES' END AS "Null", am.amname AS "Index_type", '' AS "Comment", '' AS "Index_comment", 'YES' AS "Visible", CASE WHEN k.attnum = 0 THEN pg_get_indexdef(ix.indexrelid, k.ordinality, true) ELSE NULL END AS "Expression" FROM pg_index ix JOIN pg_class t ON t.oid = ix.indrelid JOIN pg_class i ON i.oid = ix.indexrelid JOIN pg_am am ON am.oid = i.relam JOIN pg_namespace n ON n.oid = t.relnamespace JOIN LATERAL unnest(string_to_array(ix.indkey::text, ' ')::smallint[]) WITH ORDINALITY AS k(attnum, ordinality) ON TRUE LEFT JOIN pg_attribute a ON a.attrelid = t.oid AND a.attnum = k.attnum WHERE t.relkind IN ('r', 'p') AND t.relname = 'users' AND pg_table_is_visible(t.oid) AND i.relname = 'idx_users_name' AND k.ordinality <= ix.indnkeyatts ORDER BY i.relname, k.ordinality`
	if result.SQL != want {
		t.Fatalf("Translate() SQL = %q, want %q", result.SQL, want)
	}
}

func TestTranslatorTranslatesMySQLShowIndexWhereColumnNameToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SHOW INDEX FROM `users` WHERE Column_name = 'email'")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}

	want := `SELECT t.relname AS "Table", CASE WHEN ix.indisunique THEN 0 ELSE 1 END AS "Non_unique", i.relname AS "Key_name", k.ordinality AS "Seq_in_index", CASE WHEN k.attnum = 0 THEN NULL ELSE a.attname END AS "Column_name", 'A' AS "Collation", NULL AS "Cardinality", NULL AS "Sub_part", NULL AS "Packed", CASE WHEN a.attnotnull THEN '' ELSE 'YES' END AS "Null", am.amname AS "Index_type", '' AS "Comment", '' AS "Index_comment", 'YES' AS "Visible", CASE WHEN k.attnum = 0 THEN pg_get_indexdef(ix.indexrelid, k.ordinality, true) ELSE NULL END AS "Expression" FROM pg_index ix JOIN pg_class t ON t.oid = ix.indrelid JOIN pg_class i ON i.oid = ix.indexrelid JOIN pg_am am ON am.oid = i.relam JOIN pg_namespace n ON n.oid = t.relnamespace JOIN LATERAL unnest(string_to_array(ix.indkey::text, ' ')::smallint[]) WITH ORDINALITY AS k(attnum, ordinality) ON TRUE LEFT JOIN pg_attribute a ON a.attrelid = t.oid AND a.attnum = k.attnum WHERE t.relkind IN ('r', 'p') AND t.relname = 'users' AND pg_table_is_visible(t.oid) AND a.attname = 'email' AND k.ordinality <= ix.indnkeyatts ORDER BY i.relname, k.ordinality`
	if result.SQL != want {
		t.Fatalf("Translate() SQL = %q, want %q", result.SQL, want)
	}
}
...
func TestTranslatorTranslatesMySQLShowIndexWhereNonUniqueToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SHOW INDEX FROM `users` WHERE Non_unique = 0")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}

	want := `SELECT t.relname AS "Table", CASE WHEN ix.indisunique THEN 0 ELSE 1 END AS "Non_unique", i.relname AS "Key_name", k.ordinality AS "Seq_in_index", CASE WHEN k.attnum = 0 THEN NULL ELSE a.attname END AS "Column_name", 'A' AS "Collation", NULL AS "Cardinality", NULL AS "Sub_part", NULL AS "Packed", CASE WHEN a.attnotnull THEN '' ELSE 'YES' END AS "Null", am.amname AS "Index_type", '' AS "Comment", '' AS "Index_comment", 'YES' AS "Visible", CASE WHEN k.attnum = 0 THEN pg_get_indexdef(ix.indexrelid, k.ordinality, true) ELSE NULL END AS "Expression" FROM pg_index ix JOIN pg_class t ON t.oid = ix.indrelid JOIN pg_class i ON i.oid = ix.indexrelid JOIN pg_am am ON am.oid = i.relam JOIN pg_namespace n ON n.oid = t.relnamespace JOIN LATERAL unnest(string_to_array(ix.indkey::text, ' ')::smallint[]) WITH ORDINALITY AS k(attnum, ordinality) ON TRUE LEFT JOIN pg_attribute a ON a.attrelid = t.oid AND a.attnum = k.attnum WHERE t.relkind IN ('r', 'p') AND t.relname = 'users' AND pg_table_is_visible(t.oid) AND ix.indisunique AND k.ordinality <= ix.indnkeyatts ORDER BY i.relname, k.ordinality`
	if result.SQL != want {
		t.Fatalf("Translate() SQL = %q, want %q", result.SQL, want)
	}
}

func TestTranslatorTranslatesMySQLShowIndexWhereSeqInIndexToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SHOW INDEX FROM `users` WHERE Seq_in_index = 1")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}

	want := `SELECT t.relname AS "Table", CASE WHEN ix.indisunique THEN 0 ELSE 1 END AS "Non_unique", i.relname AS "Key_name", k.ordinality AS "Seq_in_index", CASE WHEN k.attnum = 0 THEN NULL ELSE a.attname END AS "Column_name", 'A' AS "Collation", NULL AS "Cardinality", NULL AS "Sub_part", NULL AS "Packed", CASE WHEN a.attnotnull THEN '' ELSE 'YES' END AS "Null", am.amname AS "Index_type", '' AS "Comment", '' AS "Index_comment", 'YES' AS "Visible", CASE WHEN k.attnum = 0 THEN pg_get_indexdef(ix.indexrelid, k.ordinality, true) ELSE NULL END AS "Expression" FROM pg_index ix JOIN pg_class t ON t.oid = ix.indrelid JOIN pg_class i ON i.oid = ix.indexrelid JOIN pg_am am ON am.oid = i.relam JOIN pg_namespace n ON n.oid = t.relnamespace JOIN LATERAL unnest(string_to_array(ix.indkey::text, ' ')::smallint[]) WITH ORDINALITY AS k(attnum, ordinality) ON TRUE LEFT JOIN pg_attribute a ON a.attrelid = t.oid AND a.attnum = k.attnum WHERE t.relkind IN ('r', 'p') AND t.relname = 'users' AND pg_table_is_visible(t.oid) AND k.ordinality = 1 AND k.ordinality <= ix.indnkeyatts ORDER BY i.relname, k.ordinality`
	if result.SQL != want {
		t.Fatalf("Translate() SQL = %q, want %q", result.SQL, want)
	}
}
...
func TestTranslatorTranslatesMySQLShowTableStatusLikeToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SHOW TABLE STATUS LIKE 'user%'")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}

	want := `SELECT c.relname AS "Name", COALESCE(am.amname, 'heap') AS "Engine", NULL AS "Version", NULL AS "Row_format", CASE WHEN c.reltuples < 0 THEN NULL ELSE c.reltuples::bigint END AS "Rows", CASE WHEN c.reltuples > 0 THEN pg_relation_size(c.oid) / NULLIF(c.reltuples::bigint, 0) ELSE NULL END AS "Avg_row_length", pg_relation_size(c.oid) AS "Data_length", NULL AS "Max_data_length", pg_indexes_size(c.oid) AS "Index_length", NULL AS "Data_free", NULL AS "Auto_increment", NULL AS "Create_time", NULL AS "Update_time", NULL AS "Check_time", NULL AS "Collation", NULL AS "Checksum", NULL AS "Create_options", COALESCE(obj_description(c.oid, 'pg_class'), '') AS "Comment" FROM pg_class c JOIN pg_namespace n ON n.oid = c.relnamespace LEFT JOIN pg_am am ON am.oid = c.relam WHERE c.relkind IN ('r', 'p') AND pg_table_is_visible(c.oid) AND c.relname ILIKE 'user%' ORDER BY c.relname`
	if result.SQL != want {
		t.Fatalf("Translate() SQL = %q, want %q", result.SQL, want)
	}
}

func TestTranslatorTranslatesMySQLShowTableStatusInDatabaseLikeToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SHOW TABLE STATUS IN `appdb` LIKE 'user%'")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}

	want := `SELECT c.relname AS "Name", COALESCE(am.amname, 'heap') AS "Engine", NULL AS "Version", NULL AS "Row_format", CASE WHEN c.reltuples < 0 THEN NULL ELSE c.reltuples::bigint END AS "Rows", CASE WHEN c.reltuples > 0 THEN pg_relation_size(c.oid) / NULLIF(c.reltuples::bigint, 0) ELSE NULL END AS "Avg_row_length", pg_relation_size(c.oid) AS "Data_length", NULL AS "Max_data_length", pg_indexes_size(c.oid) AS "Index_length", NULL AS "Data_free", NULL AS "Auto_increment", NULL AS "Create_time", NULL AS "Update_time", NULL AS "Check_time", NULL AS "Collation", NULL AS "Checksum", NULL AS "Create_options", COALESCE(obj_description(c.oid, 'pg_class'), '') AS "Comment" FROM pg_class c JOIN pg_namespace n ON n.oid = c.relnamespace LEFT JOIN pg_am am ON am.oid = c.relam WHERE c.relkind IN ('r', 'p') AND n.nspname = 'appdb' AND c.relname ILIKE 'user%' ORDER BY c.relname`
	if result.SQL != want {
		t.Fatalf("Translate() SQL = %q, want %q", result.SQL, want)
	}
}

func TestTranslatorTranslatesMySQLShowTableStatusWhereNameEqualsToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SHOW TABLE STATUS WHERE Name = 'users'")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}
...
func TestTranslatorTranslatesMySQLShowTableStatusWhereCommentEqualsToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SHOW TABLE STATUS WHERE Comment = 'archived'")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}

	want := `SELECT c.relname AS "Name", COALESCE(am.amname, 'heap') AS "Engine", NULL AS "Version", NULL AS "Row_format", CASE WHEN c.reltuples < 0 THEN NULL ELSE c.reltuples::bigint END AS "Rows", CASE WHEN c.reltuples > 0 THEN pg_relation_size(c.oid) / NULLIF(c.reltuples::bigint, 0) ELSE NULL END AS "Avg_row_length", pg_relation_size(c.oid) AS "Data_length", NULL AS "Max_data_length", pg_indexes_size(c.oid) AS "Index_length", NULL AS "Data_free", NULL AS "Auto_increment", NULL AS "Create_time", NULL AS "Update_time", NULL AS "Check_time", NULL AS "Collation", NULL AS "Checksum", NULL AS "Create_options", COALESCE(obj_description(c.oid, 'pg_class'), '') AS "Comment" FROM pg_class c JOIN pg_namespace n ON n.oid = c.relnamespace LEFT JOIN pg_am am ON am.oid = c.relam WHERE c.relkind IN ('r', 'p') AND pg_table_is_visible(c.oid) AND COALESCE(obj_description(c.oid, 'pg_class'), '') = 'archived' ORDER BY c.relname`
	if result.SQL != want {
		t.Fatalf("Translate() SQL = %q, want %q", result.SQL, want)
	}
}

func TestTranslatorTranslatesMySQLShowTableStatusWhereEngineEqualsToPostgresViaParserHooks(t *testing.T) {
	t.Parallel()
	...
	result, err := translator.Translate(context.Background(), "SHOW TABLE STATUS WHERE Engine = 'heap'")
	if err != nil {
		t.Fatalf("Translate() error = %v", err)
	}

	want := `SELECT c.relname AS "Name", COALESCE(am.amname, 'heap') AS "Engine", NULL AS "Version", NULL AS "Row_format", CASE WHEN c.reltuples < 0 THEN NULL ELSE c.reltuples::bigint END AS "Rows", CASE WHEN c.reltuples > 0 THEN pg_relation_size(c.oid) / NULLIF(c.reltuples::bigint, 0) ELSE NULL END AS "Avg_row_length", pg_relation_size(c.oid) AS "Data_length", NULL AS "Max_data_length", pg_indexes_size(c.oid) AS "Index_length", NULL AS "Data_free", NULL AS "Auto_increment", NULL AS "Create_time", NULL AS "Update_time", NULL AS "Check_time", NULL AS "Collation", NULL AS "Checksum", NULL AS "Create_options", COALESCE(obj_description(c.oid, 'pg_class'), '') AS "Comment" FROM pg_class c JOIN pg_namespace n ON n.oid = c.relnamespace LEFT JOIN pg_am am ON am.oid = c.relam WHERE c.relkind IN ('r', 'p') AND pg_table_is_visible(c.oid) AND COALESCE(am.amname, 'heap') = 'heap' ORDER BY c.relname`
	if result.SQL != want {
		t.Fatalf("Translate() SQL = %q, want %q", result.SQL, want)
	}
}
