...
func TestParseOneClassifiesSetSessionTransactionIsolationAssignmentAsSupported(t *testing.T) {
	parsed, err := internalparser.ParseOne(
...
func TestParseOneClassifiesSetTransactionIsolationAssignmentDefaultSessionAsSupported(t *testing.T) {
	parsed, err := internalparser.ParseOne(
...
func TestParseOneClassifiesSetSessionTxReadOnlyOnAssignmentAsSupported(t *testing.T) {
	parsed, err := internalparser.ParseOne(
...
func TestParseOneClassifiesSetSessionTxReadOnlyTrueAssignmentAsSupported(t *testing.T) {
	parsed, err := internalparser.ParseOne(
...
func TestParseOneClassifiesSetSessionTxReadOnlyFalseAssignmentAsSupported(t *testing.T) {
	parsed, err := internalparser.ParseOne(
...
func TestParseOneClassifiesSetSessionTransactionReadOnlyAssignmentAsSupported(t *testing.T) {
	parsed, err := internalparser.ParseOne(
...
func TestParseOneClassifiesShowFullTablesWhereTableTypeAsSupported(t *testing.T) {
	parsed, err := internalparser.ParseOne(
...
func TestParseOneClassifiesShowTablesInDatabaseWhereTableNameAsSupported(t *testing.T) {
	parsed, err := internalparser.ParseOne(
		"SHOW TABLES IN `appdb` WHERE Tables_in_appdb = 'users'",
		uniquedialect.DialectMySQL,
	)
	if err != nil {
		t.Fatalf("ParseOne() error = %v", err)
...
func TestParseOneClassifiesShowVariablesWhereAsSupported(t *testing.T) {
	parsed, err := internalparser.ParseOne(
		"SHOW VARIABLES WHERE Variable_name = 'client_encoding'",
		uniquedialect.DialectMySQL,
	)
	if err != nil {
		t.Fatalf("ParseOne() error = %v", err)
...
func TestParseOneClassifiesShowColumnsWhereFieldAsSupported(t *testing.T) {
	parsed, err := internalparser.ParseOne(
...
func TestParseOneClassifiesShowFullColumnsWhereFieldAsSupported(t *testing.T) {
	parsed, err := internalparser.ParseOne(
...
func TestParseOneClassifiesShowIndexWhereColumnNameAsSupported(t *testing.T) {
	parsed, err := internalparser.ParseOne(
...
func TestParseOneClassifiesShowIndexWhereIndexTypeAsSupported(t *testing.T) {
	parsed, err := internalparser.ParseOne(
		"SHOW INDEX FROM `users` WHERE Index_type = 'BTREE'",
		uniquedialect.DialectMySQL,
	)
	if err != nil {
		t.Fatalf("ParseOne() error = %v", err)
...
func TestParseOneClassifiesShowIndexWhereSeqInIndexAsSupported(t *testing.T) {
	parsed, err := internalparser.ParseOne(
		"SHOW INDEX FROM `users` WHERE Seq_in_index = 1",
		uniquedialect.DialectMySQL,
	)
	if err != nil {
		t.Fatalf("ParseOne() error = %v", err)
...
func TestParseOneClassifiesShowTableStatusWhereEngineAsSupported(t *testing.T) {
	parsed, err := internalparser.ParseOne(
		"SHOW TABLE STATUS WHERE Engine = 'heap'",
		uniquedialect.DialectMySQL,
	)
	if err != nil {
		t.Fatalf("ParseOne() error = %v", err)
